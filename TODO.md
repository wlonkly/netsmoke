...
- Make the median marker thickness screen-space based (pixel-constrained) instead of purely data-space based so low-latency graphs do not render an oversized green band.
